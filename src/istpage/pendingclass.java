...
Button ba= new Button("Back");
 ...
 pendingclass(Stage stage){   
       // Stage stage = new Stage();
        System.out.println("hello pending class cons");
        Scene scene = new Scene(new Pane());
        stage.setTitle("Pending Case Details");
        stage.setWidth(5500);
        stage.setHeight(2100);
       final Label label = new Label("Pending Case Details");
...
ResultSet rs=stmt.executeQuery("SELECT * FROM db1.details LEFT JOIN db1.tech_window ON db1.details.serialdate = db1.tech_window.serialdate where tech_window.macstatus='pending' order by fdate desc;");
