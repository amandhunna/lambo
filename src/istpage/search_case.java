...
Button ba= new Button("Back");
    Button pr= new Button("Print Table");
  Button pr_pdf= new Button("Print");
    
search_case (Stage stage){   
      
        System.out.println("hello search cons");
        Scene scene = new Scene(new Pane());
        stage.setTitle("Search Case Details");
        stage.setWidth(5500);
        stage.setHeight(2100);
       final Label label = new Label("Search Case Details");
...
pr_pdf.setOnAction((javafx.event.ActionEvent e)  -> {
    search_printing sp = new search_printing() ; 
      sp.main1();
 });
...
ba.setOnAction(new EventHandler<ActionEvent>() {
        ...
        vbox.getChildren().addAll(label,ba,pr,pr_pdf, table_view);
