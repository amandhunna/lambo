...
import static istpage.page3fn.phone;
...
ResultSet rs=stmt.executeQuery("SELECT * FROM db1.details LEFT JOIN db1.tech_window ON "
        + "db1.details.serialdate= db1.tech_window.serialdate where phone1 = '"+phone.getText()+"' order by fdate desc;");
